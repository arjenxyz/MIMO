...
const MORE_PROVIDERS: {
  ...
  },
  {
    id: "spotify",
    label: "Spotify",
    hint: "Müzik hesabınla devam et",
    iconClass: "text-[#1DB954]",
    buttonClass:
      "border-[#e5e7eb] bg-white text-[#1f2937] shadow-[0_4px_0_#d1d5db] hover:bg-[#f9fafb]",
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden>
        <path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm4.6 14.4a.62.62 0 0 1-.85.2c-2.33-1.42-5.26-1.74-8.72-.95a.62.62 0 1 1-.28-1.22c3.78-.86 7.01-.49 9.64 1.12a.62.62 0 0 1 .21.85zm1.23-2.74a.78.78 0 0 1-1.07.26c-2.67-1.64-6.74-2.12-9.9-1.16a.78.78 0 0 1-.44-1.5c3.62-1.1 8.12-.56 11.2 1.33a.78.78 0 0 1 .21 1.07zm.1-2.86C14.8 8.9 9.3 8.72 6.4 9.6a.94.94 0 0 1-.55-1.8c3.34-1.02 9.4-.82 13.1 1.36a.94.94 0 1 1-.98 1.6z" />
      </svg>
    ),
  },
  {
      ...
      <div className="w-full space-y-3">
        ...
        >
          <span className="flex items-center gap-1.5">
            ...
            <svg viewBox="0 0 24 24" className="h-6 w-6 fill-[#1DB954]" aria-hidden>
              <path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm4.6 14.4a.62.62 0 0 1-.85.2c-2.33-1.42-5.26-1.74-8.72-.95a.62.62 0 1 1-.28-1.22c3.78-.86 7.01-.49 9.64 1.12a.62.62 0 0 1 .21.85zm1.23-2.74a.78.78 0 0 1-1.07.26c-2.67-1.64-6.74-2.12-9.9-1.16a.78.78 0 0 1-.44-1.5c3.62-1.1 8.12-.56 11.2 1.33a.78.78 0 0 1 .21 1.07zm.1-2.86C14.8 8.9 9.3 8.72 6.4 9.6a.94.94 0 0 1-.55-1.8c3.34-1.02 9.4-.82 13.1 1.36a.94.94 0 1 1-.98 1.6z" />
            </svg>
